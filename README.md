...
You can use the scripts in `generate/`. For example, to run Example 1, you can first run:
...
- `case` corresponds to the case settings in Example 1 of the paper;
...
To generate the data for Examples 2 and 3, you can run:

- `generate_e2.R`
- `generate_e3.R`

To generate the outlier setting in Example 1, you can run:

- `generate_e1out.R`

After generating the data, you can run the scripts in `simulation_cp/`. For example, for Example 1, you may run:
...
- for Example 2, you may run `simue2a4ba100.R`;
